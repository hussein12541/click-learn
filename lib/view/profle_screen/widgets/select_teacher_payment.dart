...
class TeachersScreenPayment extends StatelessWidget {
  const TeachersScreenPayment({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(title: Text("الدفع"), centerTitle: true,),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) {
                      ...
                      return PaymentView(teacherId: group.teacher_id,);
